# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-06-11 04:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(db_column='oid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.Order', verbose_name='商品ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_menu', models.ForeignKey(db_column='sub_menu_id', on_delete=django.db.models.deletion.DO_NOTHING, to='shop.SubMenu', verbose_name='父菜单')),
            ],
            options={
                'verbose_name': '二级菜单',
